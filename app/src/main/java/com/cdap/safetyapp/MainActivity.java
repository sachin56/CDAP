...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pin=(ImageView)findViewById(R.id.pinpoint);
                            ...
                            if (task.isSuccessful()) {
                                ...
                                if (document.exists()) {
                                    ...
                                    try {
                                        ...
                                        sms.sendTextMessage(user.getTelephoneNumber(), null,
                                                "\"https://www.google.com/maps/@?api=1&map_action=map&AIzaSyCpSyKWT1z1W0tglZOnGWKc1DfHCJL9ZsM",
                                                null, null);
                                    } catch (Exception e) {
